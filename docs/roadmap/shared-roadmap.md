...
| R0.2 | Remaining edge-case hardening patch (`v0.2.2`) | `planned` | `committed` | `2026-T1` | Follow-up remediations for stale re-extraction state, strict conversations JSON discovery, message timestamp coercion, and validation for `--context`/`--name`. |
