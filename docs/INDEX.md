...
- [`docs/specs/v0.2.20-split-audit.md`](specs/v0.2.20-split-audit.md): planned split-output verification command (`split-audit`) to flag suspicious removals between raw and working TXT files.
